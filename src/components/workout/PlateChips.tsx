 ...
 *
 * **איפה הוא חי:** בגיליון עריכת הסט בלבד, יחד עם `PlateHint` שמפרק את
 * המספר חזרה לפלטות. הוא ירד מהכרטיס הפעיל כשהבמה נכנסה לגובה קבוע — שם
 * יש 38 פיקסלים לשורת שבבים אחת, והיא שייכת למשקל שמציעים לסט הבא. הגיליון
 * הוא המקום שבו מקלידים משקל בשקט, וזה בדיוק מתי ספירת פלטות שימושית.
 */

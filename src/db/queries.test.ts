...
const ROUTINES: Routine[] = [
  { id: 'A', kind: 'program', name: 'אימון A', subtitle: 'חזה ויד אחורית', order: 0, isActive: true, suggestBlocks: true, items: [] },
  { id: 'B', kind: 'program', name: 'אימון B', subtitle: 'גב ויד קדמית', order: 1, isActive: true, suggestBlocks: true, items: [] },
]
